...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "jessie" do |jessie|
    ...
    jessie.vm.box_url = "https://pkg.adfinis-sygroup.ch/vagrant/adsy-debian-8.0.0.box"
  ...
  config.vm.define "wheezy" do |wheezy|
    ...
    wheezy.vm.box_url = "https://pkg.adfinis-sygroup.ch/vagrant/adsy-debian-7.7.0.box"
  ...
  config.vm.define "trusty" do |trusty|
    ...
    trusty.vm.box_url = "https://pkg.adfinis-sygroup.ch/vagrant/adsy-ubuntu-14.04.box"
  ...
  config.vm.define "vivid" do |vivid|
    ...
    vivid.vm.box_url = "https://pkg.adfinis-sygroup.ch/vagrant/adsy-ubuntu-15.04.box"
  ...
  config.vm.define "xenial" do |xenial|
    ...
    xenial.vm.box_url = "https://pkg.adfinis-sygroup.ch/vagrant/adsy-ubuntu-16.04.box"
    xenial.vm.box_download_checksum = "bf80309862a07be833bde34474ac235510c346d6689ad8df90104eecc4c1743b"
